...
./target/debug/risingwave meta --listen-addr 0.0.0.0:5690 --advertise-addr localhost:5690 --dashboard-host 0.0.0.0:5691 --state-store hummock+s3://kafka-testing-files --data-directory iceberg_hive_local_test/risingwave_data_dir --backend mem
